...
| 场景 | 推荐模型 | 理由 |
|-----|---------|------|
| 日常对话 | `ernie-3.5-8k` | 性价比最高 |
| 长文档处理 | `ernie-4.0-turbo-128k` | 128K上下文 |
| 复杂推理 | `deepseek-r1` | 思维链能力强 |
| 代码开发 | `deepseek-v3` / `qwen3-coder` | 代码专长 |
| 图像理解 | `ernie-4.5-turbo-vl` | 多模态能力 |
| 快速响应 | `ernie-tiny-8k` | 速度最快 |
| 最新技术 | `ernie-4.5-turbo-128k-preview` | 最新旗舰 |

### 按成本选择

| 成本等级 | 推荐模型 |
|---------|---------|
| 低成本 | `ernie-tiny-8k`, `ernie-lite-8k` |
| 中等成本 | `ernie-3.5-8k`, `ernie-speed-8k` |
| 高性能 | `ernie-4.0-turbo-128k`, `ernie-4.5-turbo-128k-preview` |
