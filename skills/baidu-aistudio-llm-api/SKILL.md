...
| 使用场景 | 推荐模型 | 说明 |
|---------|---------|------|
| 通用对话 | `ernie-3.5-8k` | 性价比高，适合日常使用 |
| 复杂推理 | `ernie-4.0-turbo-8k` | 更强的理解和推理能力 |
| 超长文本 | `ernie-4.0-turbo-128k` | 128K上下文，处理长文档 |
| 深度思考 | `deepseek-r1` | 思维链推理，复杂问题 |
| 代码生成 | `deepseek-v3` | 代码能力强 |
| 最新旗舰 | `ernie-4.5-turbo-128k-preview` | 最新ERNIE 4.5模型 |
...
**支持联网搜索的模型：** ernie-4.5, ernie-4.0-turbo, ernie-3.5, deepseek-r1, deepseek-v3
...
**支持Function Call的模型：** ernie-x1-turbo-32k, deepseek-r1, deepseek-v3
